...
// * Embed Survey dialog
// */
// // private static void initializeSDK(Application context, String token,
// String
// // zfRegion) {
...
// // DataManager.getInstance().hitSurveyActiveApi(survey.getSurveyToken(),
// false);
// // }
...
// // if (survey.getCustomAttributes() != null &&
...
// {
// // customVariableString = "";
// // url = url + "externalVisitorId" + "=" +
// // DataManager.getInstance().getExternalVisitorId() + "&";
// // }
...
// // /**
// // * This method will help user to pass user related details such as Email,
// user
// // * name etc.
// // *
// // * @param hashMap
...
// // if (TextUtils.isEmpty(DataManager.getInstance().getContactId())) {
// // if (TextUtils.isEmpty(DataManager.getInstance().getExternalVisitorId())) {
// // DataManager.getInstance().createContact(mContext, survey.getSurveyToken(),
// // false);
// // } else {
// // DataManager.getInstance().hitSurveyActiveApi(survey.getSurveyToken(),
// true);
...
// // /*
// // * Clear the data of the list so that when API call is being made the next
// // time,
...
// // /**
// // * This function is used to get Email id, Mobile Number and Unique Id from
// the
// // * user to make an
